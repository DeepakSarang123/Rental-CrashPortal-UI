...
export class Home2Component implements OnInit {
  ...
  filterChange(filter, event) {
    ...
    console.log( 'initial fdata' + this.dataSource.filteredData);
    ...
    console.log('ds filter:' + this.dataSource.filter);
    this.dataSource.data = this.dataSource.filteredData;
    console.log('ds data' + this.dataSource.data);
    console.log('ds fdata' + this.dataSource.filteredData);
  }
  ...
  createFilter() {
    let filterFunction = function (data: any, filter: string): boolean {
      ...
      let nameSearch = () => {
        ...
        if (isFilterSet) {
          for (const col in searchTerms) {
            console.log('searchterms[col]'+searchTerms[col]);
