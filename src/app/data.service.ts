...
import { catchError, map, refCount, publishLast, takeLast, take, timeout } from 'rxjs/operators';
...
export class DataService {
  ...
  constructor(public injector: Injector, private _router: Router, private _http: HttpClient, public sentryErrorHandler: SentryErrorHandler) {
  ...
  callRestful(type: string, url: string, options?: { params?: {}, body?: {}, headerData?: {} }) {
    ...
    switch (type) {
      case 'GET':
        ...
        return this._http.get(url, getOptions).pipe(timeout(10000), map(res => {
  ...
  private handleError(error: HttpErrorResponse | any) {
    // console.log(JSON.stringify(error) + "0000000")
